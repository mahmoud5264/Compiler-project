...
write1.close();
        ...
        int a=3;
        int b=4;
        if((AddExpression(1)||a<=b)) {//block number 2
try{
...
a++;}
        if((AddExpression(2)||a>b)) {//block number 3
try{
...
a--;}
        else if((AddExpression(3)||b>a)) {//block number 4
try{
...
a++;}
        if((AddExpression(4)||a==b)){//block number 6
try{
